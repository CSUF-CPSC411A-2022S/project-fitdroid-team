package com.example.fitdroid.adapter
...
class FoodListAdapter(
    ...
    class ItemViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        ...
        val foodItemName: TextView = view.findViewById(R.id.foodItemName)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        /**
         * We retrieve the corresponding food name from our dataset so it is displayed in
