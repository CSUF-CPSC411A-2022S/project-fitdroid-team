...
/**
 * Manages the database that stores the Calories table and its entitites.
...
abstract class CaloriesDatabase: RoomDatabase() {
    ...
    abstract val caloriesDao: CaloriesDao

    companion object {
        // Holds a reference to the database.
        @Volatile
        private var INSTANCE: CaloriesDatabase? = null // This class
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        ...
                        CaloriesDatabase::class.java, // Your database class
                        "calories_database"
                    )
